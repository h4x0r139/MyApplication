    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.previous)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "[onClick previous]，mposition=" + position + " previous=" + (position - 1));
                if ((position - 1) >= 0) {
                    position = position - 1;
//                viewPager.setCurrentItem(position, false);
        ...
        ((Button) findViewById(R.id.next)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "[onClick next]，mposition=" + position + " next=" + (position + 1));
...
//        System.out.println("[onPageSelected]，position="+position);
        Log.d(TAG, "[onPageSelected]，position=" + position + ", mposition=" + this.position);
