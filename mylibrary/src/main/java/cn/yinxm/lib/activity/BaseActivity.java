...
//                            LogUtil.d("获取到READ_PHONE_STATE权限，执行软件更新和考拉初始化 deviceId=" + DeviceUtil.getDeviceId(context) + ", WorkEcConfig deviceId=" + MyAppManager.getInstance().getWorkEcConfig().getDeviceId());
//                            MyAppManager.getInstance().getWorkEcConfig().setDeviceId(DeviceUtil.getDeviceId(context));
//                            LogUtil.d("WorkEcConfig deviceId=" + MyAppManager.getInstance().getWorkEcConfig().getDeviceId());
//                            updateVersion();
//                            KaolaUtil.getOpenid(BaseApplication.getContext());
                ...
                if (Manifest.permission.READ_CONTACTS.equals(permission)) {
                    ...
                    permissionCheck.permissionGrantResult = new PermissionGrantResult() {
                        ...
                        public void permissionGranted(String permission) {
//                            Context context = BaseApplication.getContext();
//                            LogUtil.d("获取到READ_CONTACTS权限，执行上传通讯录WorkEcConfig deviceId=" + MyAppManager.getInstance().getWorkEcConfig().getDeviceId());
//                            // 上传通讯录
