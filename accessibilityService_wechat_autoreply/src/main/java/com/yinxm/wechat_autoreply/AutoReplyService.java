package com.yinxm.wechat_autoreply;
...
//    private final static String MM_PNAME = "com.tencent.mm";
    private  String MM_PNAME = getResources().getString(R.string.listen_pacakage);
    ...
    public void onAccessibilityEvent(final AccessibilityEvent event) {
        ...
        switch (eventType) {
            ...
            case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:
                ...
                Log.d("maptrix", "className="+className);
    ...
    private boolean fill() {
        ...
        if (rootNode != null) {
            return findEditText(rootNode, "this is test auto reply");
