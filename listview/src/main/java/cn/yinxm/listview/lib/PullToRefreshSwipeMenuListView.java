...
import cn.yinxm.listview.R;
import cn.yinxm.listview.lib.pulltorefresh.interfaces.IXListViewListener;
import cn.yinxm.listview.lib.pulltorefresh.interfaces.OnXScrollListener;
import cn.yinxm.listview.lib.pulltorefresh.view.PullToRefreshListFooter;
import cn.yinxm.listview.lib.pulltorefresh.view.PullToRefreshListHeader;
import cn.yinxm.listview.lib.swipemenu.adapter.SwipeMenuAdapter;
import cn.yinxm.listview.lib.swipemenu.bean.SwipeMenu;
import cn.yinxm.listview.lib.swipemenu.interfaces.OnMenuItemClickListener;
import cn.yinxm.listview.lib.swipemenu.interfaces.OnSwipeListener;
import cn.yinxm.listview.lib.swipemenu.interfaces.SwipeMenuCreator;
import cn.yinxm.listview.lib.swipemenu.view.SwipeMenuLayout;
...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
     ...
     */
    public void setPullLoadEnable(boolean enable,boolean finish) {
        ...
        if (!mEnablePullLoad) {
            ...
            if(isfinish){
                mFooterView.setState(PullToRefreshListFooter.STATE_NOMORE);
            }else {
     ...
     */
    public void stopLoadMore(boolean finish) {
        isfinish=finish;
    ...
    public void setAllXMListViewListener(Object l){
        mListViewListener = (IXListViewListener) l;
    }
}
