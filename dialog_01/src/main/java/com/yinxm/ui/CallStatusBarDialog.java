...
public class CallStatusBarDialog extends Dialog{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("yinxm", "[CallStatusBarDialog.onCreate]");
...
//            dialog.setCanceledOnTouchOutside(false);
        ...
        dialogContentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("yinxm", "[CallStatusBarDialog.onclick]");
...
//                mContext.startActivity(intent);
    ...
    private void resetWidthHeight() {
        Log.d("yinxm", "[CallStatusBarDialog.resetWidthHeight]");
        Window dialogWindow = getWindow();
        WindowManager.LayoutParams layoutParams = dialogWindow.getAttributes();
        if (title == null) {
            Log.d("yinxm", "CallStatusBarDialog title null");
            layoutParams.x = 0;
        } else {
            int[] showLocation = new int[2];
            title.getLocationOnScreen(showLocation);
            Log.d("yinxm", "showLocation[0]=" + showLocation[0] + ", showLocation[1]=" + showLocation[1]+", height="+title.getHeight());
