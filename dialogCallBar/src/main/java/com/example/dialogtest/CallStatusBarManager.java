...
public class CallStatusBarManager {
    ...
    public void addCallStatusBar(Activity activity, View titleLayout) {
        LogUtil.d("[CallStatusBarManager.addCallStatusBar] activity=" + activity+", name="+activity.getClass().getName());
    ...
    public void updateVisibleCallStatusBar(Activity activity) {
        ...
        LogUtil.d("[CallStatusBarManager.updateVisibleCallStatusBar] activity=" + activity +", className="+className+ ", map=" + callStatusBarDialogMap);
