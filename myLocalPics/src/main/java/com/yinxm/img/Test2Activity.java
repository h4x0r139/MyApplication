...
//        }
        if (c == null) {
//            c = resolver.query(MediaStore.Images.Media.getContentUri("work_ec"), projection, null, null, null);
//            Log.d("yinxm", "cursor="+c+", url="+ MediaStore.Images.Media.getContentUri("work_ec"));
