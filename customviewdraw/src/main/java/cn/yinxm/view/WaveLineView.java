...
public class WaveLineView extends View {
    ...
    public WaveLineView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.WaveLineView, defStyleAttr, R.style.style_wave_line_def);
    ...
    private void initTools() {
        ...
        waveFirstPaint.setStyle(Paint.Style.STROKE);
