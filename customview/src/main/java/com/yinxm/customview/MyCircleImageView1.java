 ...
 */
public class MyCircleImageView1 extends ImageView {

    private int width;//最外层圆形外接矩形宽度
    private int progressWidth;//进度条宽度

    //基本的三个构造函数
    public MyCircleImageView1(Context context) {
        super(context);
    }

    public MyCircleImageView1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyCircleImageView1(Context context, AttributeSet attrs, int defStyle) {
