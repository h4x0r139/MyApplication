...
public class ToAddrDetailMod extends JiaDeNetRequestTask
{
  ...
  public ToAddrDetailMod(JiaDeNetRequestTask.JiaDeNetCallback paramJiaDeNetCallback, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12)
  {
    ...
    this.parmas.put("toCountry", paramString4);
    this.parmas.put("toProvince", paramString5);
    this.parmas.put("toCity", paramString6);
    this.parmas.put("toAddress", paramString7);
    this.parmas.put("toPerson", paramString8);
    this.parmas.put("telephone", paramString9);
    this.parmas.put("zipCode", paramString10);
    this.parmas.put("email", paramString11);
    this.parmas.put("identityNo", paramString12);
    this.mContext = paramContext;
  }

  public JiaDeNetRequest getRequest()
  {
    return new JiaDeNetRequest(BASE_URL + "personal/toAddrDetailMod", "toAddrDetailMod", false, this.parmas, this.mContext);
  }
 ...
 * Qualified Name:     com.tg.jiadeonline.net.ToAddrDetailMod
