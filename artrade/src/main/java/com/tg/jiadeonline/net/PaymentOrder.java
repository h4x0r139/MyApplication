...
public class PaymentOrder extends JiaDeNetRequestTask
{
  Context mContext;
  Map<String, Object> parmas = new HashMap();

  public PaymentOrder(JiaDeNetRequestTask.JiaDeNetCallback paramJiaDeNetCallback, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
  ...
  {
    return new JiaDeNetRequest(BASE_URL + "personal/order/paymentOrder", "paymentOrder", false, this.parmas, this.mContext);
  }
    ...
    throws Exception
  {
    ...
    for (int i = 0; ; i++)
    {
      ...
      String str21 = localJSONObject3.getString("invoice");
      String str22 = localJSONObject3.getString("itemData");
      ...
      if (str21 == null)
        str21 = "";
      localPaymentOrderBean.setInvoice(str21);
      if (str6 == null)
        str6 = "";
      ...
      if (str22 == null)
        str22 = "";
      localPaymentOrderBean.setItemData(str22);
 ...
 * Qualified Name:     com.tg.jiadeonline.net.PaymentOrder
