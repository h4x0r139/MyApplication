...
public class Mtenpay extends JiaDeNetRequestTask
{
  Context mContext;
  Map<String, Object> parmas = new HashMap();

  public Mtenpay(JiaDeNetRequestTask.JiaDeNetCallback paramJiaDeNetCallback, Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  {
    return new JiaDeNetRequest(BASE_URL + "payment/tenpay/mtenpay", "mtenpay", false, this.parmas, this.mContext);
  }
 ...
 * Qualified Name:     com.tg.jiadeonline.net.Mtenpay
