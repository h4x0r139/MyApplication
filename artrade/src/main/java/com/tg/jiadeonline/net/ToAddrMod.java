...
public class ToAddrMod extends JiaDeNetRequestTask
{
  Context mContext;
  Map<String, Object> parmas = new HashMap();

  public ToAddrMod(JiaDeNetRequestTask.JiaDeNetCallback paramJiaDeNetCallback, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    this.parmas.put("toAddressId", paramString4);
    this.mContext = paramContext;
  }

  public JiaDeNetRequest getRequest()
  {
    return new JiaDeNetRequest(BASE_URL + "personal/toAddrMod", "toAddrMod", false, this.parmas, this.mContext);
  }
 ...
 * Qualified Name:     com.tg.jiadeonline.net.ToAddrMod
