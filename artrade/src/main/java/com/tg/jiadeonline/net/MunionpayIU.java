...
public class MunionpayIU extends JiaDeNetRequestTask
{
  Context mContext;
  Map<String, Object> parmas = new HashMap();

  public MunionpayIU(JiaDeNetRequestTask.JiaDeNetCallback paramJiaDeNetCallback, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
  ...
  {
    return new JiaDeNetRequest(BASE_URL + "payment/up/munionpayIU", "munionpayIU", false, this.parmas, this.mContext);
  }
 ...
 * Qualified Name:     com.tg.jiadeonline.net.MunionpayIU
