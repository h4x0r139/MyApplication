...
public class SpecialFieldlist extends JiaDeNetRequestTask
{
  Context mContext;
  Map<String, Object> parmas = new HashMap();

  public SpecialFieldlist(JiaDeNetRequestTask.JiaDeNetCallback paramJiaDeNetCallback, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
  ...
  {
    return new JiaDeNetRequest(BASE_URL + "listings/blist", "blist", false, this.parmas, this.mContext);
  }
 ...
 * Qualified Name:     com.tg.jiadeonline.net.SpecialFieldlist
