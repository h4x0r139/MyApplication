...
final class GZIPCodec
{
    ...
    throws java.io.IOException
  {
    ...
    //   16: astore_2
    //   17: new 25	java/util/zip/GZIPInputStream
    //   20: dup
    //   21: aload_1
    //   22: invokespecial 28	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   25: astore_3
    //   26: sipush 512
    //   29: newarray byte
    //   31: astore 5
    //   33: aload_3
    //   34: aload 5
    //   36: invokevirtual 32	java/util/zip/GZIPInputStream:read	([B)I
    //   39: istore 6
    //   41: iload 6
    //   43: ifle +12 -> 55
    //   46: aload_2
    ...
    //   64: astore 7
    //   66: aload_3
    //   67: invokevirtual 43	java/util/zip/GZIPInputStream:close	()V
    //   70: aload_2
    ...
    //   80: astore_3
    //   81: aload_3
    //   82: invokevirtual 43	java/util/zip/GZIPInputStream:close	()V
    //   85: aload_2
    ...
    throws java.io.IOException
  {
    ...
    //   7: astore_1
    //   8: new 47	java/util/zip/GZIPOutputStream
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 50	java/util/zip/GZIPOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore_2
    //   17: aload_2
    //   18: aload_0
    //   19: invokevirtual 52	java/util/zip/GZIPOutputStream:write	([B)V
    //   22: aload_2
    //   23: invokevirtual 53	java/util/zip/GZIPOutputStream:close	()V
    //   26: aload_1
    ...
    //   34: astore 4
    //   36: aload_2
    //   37: invokevirtual 53	java/util/zip/GZIPOutputStream:close	()V
    //   40: aload_1
    ...
    //   49: astore_2
    //   50: aload_2
    //   51: invokevirtual 53	java/util/zip/GZIPOutputStream:close	()V
    //   54: aload_1
 ...
 * Qualified Name:     com.kenai.jbosh.GZIPCodec
